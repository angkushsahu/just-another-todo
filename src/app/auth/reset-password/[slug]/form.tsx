...
import { type ResetPasswordType, resetPasswordSchema } from "@/validation";

export type ResetPasswordFormProps = { resetId: string };

export default function ResetPasswordForm({ resetId }: ResetPasswordFormProps) {
